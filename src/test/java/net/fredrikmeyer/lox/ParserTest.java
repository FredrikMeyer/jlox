...
class ParserTest {
    ...
    void parse() {
        ...
        assertEquals(new Expr.Literal(5), parse);
    }
    ...
    void test_parsing_parenthized_expression() {
        ...
        assertEquals(astPrinter.visit(new Expr.Grouping(
                new Expr.Binary(new Expr.Literal(5), new Token(TokenType.PLUS, "+", "1", 1), new Expr.Literal(3))
        )), "(group (+ 5 3))");
    }
}